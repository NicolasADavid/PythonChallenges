...
# the growth rate for that app. These apps will all be launched at the same time and no user ever uses 
# more than one of the apps. We want to know how many total users there are when you add together the number of 
# users from each app.
